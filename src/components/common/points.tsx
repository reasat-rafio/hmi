...
export const Points: React.FC<Point> = ({ name, cta }) => {
    return (
        <div className="border-b box-border border-gray p-5 bg-white hover:cursor-pointer hover:drop-shadow-2xl box-border transition-all duration-150 group relative hover:z-30">
